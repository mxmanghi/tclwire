# http_codes.tcl --
#
# HTTP status codes and their conventional reason phrases.
...
namespace eval ::tclwire::http::codes {
    ...
    namespace export all reason
    namespace ensemble create
}

package provide tclwire::http::codes 0.1
